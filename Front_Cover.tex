...
\thesislogo{2.5cm}{9cm}{./Images/SR03_Monaco.jpg}
...
% REQUIRED: Thesis 
\title{Fast response MPPT switched charger for the Técnico Solar Boat }
...
% REQUIRED: Author
% Author full Name
\author{Afonso Daniel Guerreiro Coelho}
%
% -----------------------------------------------------------------------------
...
\supervisor{Gonçalo Nuno Gomes Tavares}
% If no co-Supervisor comment the next line
\othersupervisor{Pedro Rafael Bonifacio Vitor}
%
% -----------------------------------------------------------------------------
