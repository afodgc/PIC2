...
\usepackage{booktabs}
\definecolor{light_green}{RGB}{198,239,206} % light green
\definecolor{light_red}{RGB}{255,200,200} % light red
\definecolor{light_yellow}{RGB}{255,255,153} % light yellow
\definecolor{dark_green}{RGB}{0,200,0} % dark green

\newcommand{\G}{\cellcolor{light_green}}
\newcommand{\R}{\cellcolor{light_red}}
\newcommand{\Y}{\cellcolor{light_yellow}}
\newcommand{\DG}{\cellcolor{dark_green}}
...
% Chapter number font
\newcommand{\chapnumfont}{%
    \fontsize{90}{100}\bfseries\color{gray!60}
}

% ---------- Chapter Format ----------
% Use 'block' instead of 'display' to keep title and number on the same line
\titleformat{\chapter}[block]
  {\normalfont}
  {\chapnumfont\thechapter}
  {2em} % horizontal spacing between number and title
  {\Huge\bfseries} % title appearance
