\fancychapter{Preliminary Work}
    ...
    \section{Hardware tests}
        ...
        The tests conducted were based on online examples, which allowed the evaluation of several functionalities of this \acs{mcu}, including timers, interrupts, basic GPIO operations, PWM generation, ADC usage, and communication interfaces such as USB, CAN, and I²C.
