...
\section{Outline}
    ...
    \begin{itemize}[leftmargin=4em, itemsep=1pt, topsep=2pt]
        ...
        \item \textbf{Chapter 3} describes the proposed solution for the \acs{mppt} system. The overall system architecture is presented, followed by a summary of the technical requirements. The adopted design approach and methodology are detailed, including \textcolor{red}{converter selection}, control strategy, simulation, and experimental validation plan.
