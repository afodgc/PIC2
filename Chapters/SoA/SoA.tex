...
\section{Processing unit}
    \subsection{FPGA}
        ...
        Assuming that there is no IC perfect for this application, what are the options? The main options are \acp{mcu} or \acp{fpga}. There is also some less powerful options like \acp{cpld} and \acs{dsp} but usually they are to complex to work with and not powerful enough. Lets focused in \acs{fpga} for now. 
...
\section{Commercial \acs{mppt}s}
    ...
    \begin{adjustbox}{max width=0.95\textwidth}
        ...
        Communication & No & \cellcolor[RGB]{255,200,200}Yes (VE.can/ Bluetooth) & Yes & \cellcolor[RGB]{255,200,200}Bluetooth and RS485 & Bluetooth \\
        ...
        Price & \cellcolor[RGB]{255,200,200}240€ & 100-200€ & \cellcolor[RGB]{255,200,200}Components: 250-280€ PCB:20-100€ Total:270-380€ & 300-350€ & 120-160€ \\
        \bottomrule
        \end{tabularx}
    \end{adjustbox}
    \end{table}
