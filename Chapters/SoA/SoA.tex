...
\section{MPPT Algorithms}
    ...
    \subsection{Constant Voltage}
        This is the simplest and the most inefficient method. It works by operating the solar panel at a fixed voltage. The reference voltage is the input of a Proportional-Integral-Derivative (PID) controller (simple and classic type of controller) that will adjust the operation of the DC-DC converter to maintain the solar panel voltage at this reference value.
