...
\section{MPPT Algorithms}
    ...
    \subsection{Incremental Conductance (IncCond)}
        ...
        \subsection{Look Up Table (LUT)}
            ...
            Table~\ref{tab:LUT_matrix} is visual representation of a 2D LUT, only based on current and voltage.
            ...
            The main advantage of this method is its speed since it can reach the \ac{mpp} in one clock cycle. This makes it suitable for applications where fast tracking is required, like in this project. Also, research show less output ripple and higher output power at some levels of irradiance. However, it is not very acquired~\cite{Look-Up-Table_VS_PeO}.
