...
\section{System architecture}
    ...
    \subsection{Requirements summary}
        ...
        \begin{itemize}[leftmargin=4em, itemsep=1pt, topsep=2pt]
            ...
            \item Input maximum rating: 15~A and 50~V;
...
\section{Methodology}
    \subsection{Simulations and Design}
        To satisfy the system requirements while maintaining operational flexibility, a step-up/step-down \acs{dc}-\acs{dc} converter topology is selected. This configuration enables operation under both low input and high output, or high input and low output voltage conditions. Furthermore, even when the solar panel and battery voltages are similar, this converter topology allows operation at the \acs{mpp}, ensuring efficient energy harvesting.
